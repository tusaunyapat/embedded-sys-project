...
function useButton(parameters = {}) {
  ...
  const getRootProps = (externalProps = {}) => {
    const externalEventHandlers = _extends3({}, extractEventHandlers(parameters), extractEventHandlers(externalProps));
    const props = _extends3({
      type
...
var Badge = React18.forwardRef(function Badge2(props, forwardedRef) {
  ...
  return (0, import_jsx_runtime3.jsxs)(Root, _extends3({}, rootProps, {
    children: [children, (0, import_jsx_runtime3.jsx)(BadgeComponent, _extends3({}, badgeProps, {
...
var Button = React19.forwardRef(function Button2(props, forwardedRef) {
  ...
  return (0, import_jsx_runtime4.jsx)(Root, _extends3({}, rootProps, {
    children
  }));
});
...
function getControlledState(internalState, controlledProps) {
  const augmentedState = _extends3({}, internalState);
...
var FormControl = React26.forwardRef(function FormControl2(props, forwardedRef) {
  ...
  return (0, import_jsx_runtime7.jsx)(FormControlContext.Provider, {
    value: childContext,
    children: (0, import_jsx_runtime7.jsx)(Root, _extends3({}, rootProps))
  });
});
...
function useInput(parameters = {}) {
  ...
  const getRootProps = (externalProps = {}) => {
    ...
    const externalEventHandlers = _extends3({}, propsEventHandlers, extractEventHandlers(externalProps));
    return _extends3({}, externalProps, externalEventHandlers, {
  ...
  const getInputProps = (externalProps = {}) => {
    ...
    const externalEventHandlers = _extends3({}, propsEventHandlers, extractEventHandlers(externalProps));
    const mergedEventHandlers = _extends3({}, externalEventHandlers, {
      onBlur: handleBlur2(externalEventHandlers),
      onChange: handleChange(externalEventHandlers),
      onFocus: handleFocus(externalEventHandlers)
    });
    return _extends3({}, mergedEventHandlers, {
...
var Input = React29.forwardRef(function Input2(props, forwardedRef) {
  ...
  const inputProps = useSlotProps({
    ...
    getSlotProps: (otherHandlers) => {
      return getInputProps(_extends3({}, propsToForward, otherHandlers));
    },
    externalSlotProps: slotProps.input,
    additionalProps: _extends3({
  ...
  return (0, import_jsx_runtime8.jsxs)(Root, _extends3({}, rootProps, {
    children: [startAdornment, (0, import_jsx_runtime8.jsx)(InputComponent, _extends3({}, inputProps)), endAdornment]
  }));
});
...
function useList(params) {
  ...
  const actionContext = React31.useMemo(() => _extends3({}, reducerActionContext, listActionContext), [reducerActionContext, listActionContext]);
  const [state, dispatch] = useControllableReducer({
    reducer,
    actionContext,
    initialState,
  ...
  const getRootProps = (externalProps = {}) => {
    ...
    return _extends3({}, externalProps, {
...
function combineHooksSlotProps(getFirstProps, getSecondProps) {
  return function getCombinedProps(external = {}) {
    const firstResult = _extends3({}, external, getFirstProps(external));
    const result = _extends3({}, firstResult, getSecondProps(firstResult));
    return result;
  };
}
...
function useMenu(parameters = {}) {
  ...
  const getListboxProps = (externalProps = {}) => {
    ...
    const externalEventHandlers = extractEventHandlers(externalProps);
    return _extends3({}, externalProps, externalEventHandlers, getCombinedRootProps(externalEventHandlers), {
      id: listboxId,
      role: "menu"
    });
  };
  ...
  return {
    contextValue: _extends3({}, compoundComponentContextValue, listContextValue),
    dispatch: listDispatch,
    getListboxProps,
    highlightedValue,
...
function useFloating(options) {
  ...
  const [latestMiddleware, setLatestMiddleware] = React38.useState(middleware2);
  ...
  const setReference = React38.useCallback((node2) => {
    if (node2 !== referenceRef.current) {
      referenceRef.current = node2;
      _setReference(node2);
    }
  }, []);
  const setFloating = React38.useCallback((node2) => {
...
var Popup = React44.forwardRef(function Popup2(props, forwardedRef) {
  ...
  const {
    ...
    open,
    middleware: middleware2 ?? [offset2(offsetProp ?? 0), flip2(), shift2()],
    placement,
    strategy,
  ...
  const rootProps = useSlotProps({
    ...
    additionalProps: {
      ref: handleRef,
      role: "tooltip",
      style: _extends3({}, floatingStyles, {
  ...
  return (0, import_jsx_runtime11.jsx)(Portal, {
    ...
    children: (0, import_jsx_runtime11.jsx)(PopupContext.Provider, {
      ...
      children: (0, import_jsx_runtime11.jsx)(TransitionContext.Provider, {
        value: contextValue,
        children: (0, import_jsx_runtime11.jsx)(Root, _extends3({}, rootProps, {
          children
        }))
      })
    })
...
var Menu = React45.forwardRef(function Menu2(props, forwardedRef) {
  ...
  if (open === true && anchor == null) {
    return (0, import_jsx_runtime12.jsx)(Root, _extends3({}, rootProps, {
      children: (0, import_jsx_runtime12.jsx)(Listbox, _extends3({}, listboxProps, {
  ...
  return (0, import_jsx_runtime12.jsx)(Popup, _extends3({
    keepMounted: true
  }, rootProps, {
    open,
    anchor,
...
var MenuButton = React47.forwardRef(function MenuButton2(props, forwardedRef) {
  ...
  return (0, import_jsx_runtime13.jsx)(Root, _extends3({}, rootProps, {
    children
  }));
});
...
function useMenuItem(params) {
  ...
  const getOwnHandlers = (otherHandlers = {}) => _extends3({}, otherHandlers, {
    onClick: createHandleClick(otherHandlers)
  });
...
var InnerMenuItem = React50.memo(React50.forwardRef(function MenuItem(props, forwardedRef) {
  ...
  return (0, import_jsx_runtime14.jsx)(Root, _extends3({}, rootProps, {
    children
  }));
}));
var MenuItem2 = React50.forwardRef(function MenuItem3(props, ref) {
  ...
  return (0, import_jsx_runtime14.jsx)(ListContext.Provider, {
    value: contextValue,
    children: (0, import_jsx_runtime14.jsx)(InnerMenuItem, _extends3({}, props, {
      id,
      ref
    }))
  });
...
function useModal(parameters) {
  ...
  const getRootProps = (otherHandlers = {}) => {
    ...
    const externalEventHandlers = _extends3({}, propsEventHandlers, otherHandlers);
    return _extends3({
      role: "presentation"
    }, externalEventHandlers, {
      onKeyDown: createHandleKeyDown(externalEventHandlers),
...
var Modal = React52.forwardRef(function Modal2(props, forwardedRef) {
  ...
  const propsWithDefaults = _extends3({}, props, {
  ...
  const {
    ...
    exited,
    hasTransition
  } = useModal(_extends3({}, propsWithDefaults, {
    rootRef: forwardedRef
  }));
  const ownerState = _extends3({}, propsWithDefaults, {
    exited,
    hasTransition
  });
  ...
  const backdropProps = useSlotProps({
    ...
    getSlotProps: (otherHandlers) => {
      return getBackdropProps(_extends3({}, otherHandlers, {
        onClick: (e) => {
          if (onBackdropClick) {
            onBackdropClick(e);
          }
  ...
  return (0, import_jsx_runtime15.jsx)(Portal, {
    ...
    container,
    disablePortal,
    children: (0, import_jsx_runtime15.jsxs)(Root, _extends3({}, rootProps, {
      children: [!hideBackdrop && BackdropComponent ? (0, import_jsx_runtime15.jsx)(BackdropComponent, _extends3({}, backdropProps)) : null, (0, import_jsx_runtime15.jsx)(FocusTrap, {
        disableEnforceFocus,
        disableAutoFocus,
        disableRestoreFocus,
...
function handleClamp(state, context, inputValue) {
  ...
  return _extends3({}, state, clampedValues);
}
...
function useNumberInput(parameters) {
  ...
  const getInputProps = (externalProps = {}) => {
    ...
    const mergedEventHandlers = _extends3({}, externalEventHandlers, {
      ...
      onChange: createHandleInputChange(_extends3({}, externalEventHandlers, {
  ...
  const getIncrementButtonProps = (externalProps = {}) => {
    return _extends3({}, externalProps, stepperButtonCommonProps, {
...
var NumberInput = React55.forwardRef(function NumberInput2(props, forwardedRef) {
  ...
  const inputProps = useSlotProps({
    elementType: Input3,
    getSlotProps: (otherHandlers) => getInputProps(_extends3({}, propsForwardedToInputSlot, otherHandlers)),
    externalSlotProps: slotProps.input,
    ownerState,
    className: classes.input
  });
  ...
  return (0, import_jsx_runtime17.jsxs)(Root, _extends3({}, rootProps, {
    children: [(0, import_jsx_runtime17.jsx)(DecrementButton, _extends3({}, decrementButtonProps)), (0, import_jsx_runtime17.jsx)(IncrementButton, _extends3({}, incrementButtonProps)), startAdornment, (0, import_jsx_runtime17.jsx)(Input3, _extends3({}, inputProps)), endAdornment]
  }));
});
...
var OptionGroup = React56.forwardRef(function OptionGroup2(props, forwardedRef) {
  ...
  return (0, import_jsx_runtime18.jsxs)(Root, _extends3({}, rootProps, {
    children: [(0, import_jsx_runtime18.jsx)(Label, _extends3({}, labelProps, {
      children: props.label
    })), (0, import_jsx_runtime18.jsx)(List, _extends3({}, listProps, {
...
var InnerOption = React59.memo(React59.forwardRef(function Option(props, forwardedRef) {
  ...
  return (0, import_jsx_runtime19.jsx)(Root, _extends3({}, rootProps, {
    children
  }));
}));
var Option2 = React59.forwardRef(function Option3(props, ref) {
  ...
  return (0, import_jsx_runtime19.jsx)(ListContext.Provider, {
    value: contextValue,
    children: (0, import_jsx_runtime19.jsx)(InnerOption, _extends3({}, props, {
      ref
    }))
  });
});
...
function getNodeScroll2(node2) {
  if (node2 === getWindow2(node2) || !isHTMLElement2(node2)) {
...
var PopperTooltip = React60.forwardRef(function PopperTooltip2(props, forwardedRef) {
  ...
  useEnhancedEffect_default(() => {
    ...
    const popper2 = createPopper3(resolvedAnchorElement, tooltipRef.current, _extends3({
  ...
  return (0, import_jsx_runtime20.jsx)(Root, _extends3({}, rootProps, {
...
var Popper = React60.forwardRef(function Popper2(props, forwardedRef) {
  ...
  return (0, import_jsx_runtime20.jsx)(Portal, {
    disablePortal,
    container,
    children: (0, import_jsx_runtime20.jsx)(PopperTooltip, _extends3({
      anchorEl,
      direction,
      disablePortal,
      modifiers,
...
function useSelect(props) {
  ...
  const getSelectTriggerProps = (otherHandlers = {}) => {
    return _extends3({}, otherHandlers, getButtonOwnRootProps(otherHandlers), {
      role: "combobox",
      "aria-expanded": open,
  ...
  const getButtonProps = (externalProps = {}) => {
    ...
    return _extends3({}, externalProps, combinedProps(externalEventHandlers));
  };
  ...
  const contextValue = React61.useMemo(() => _extends3({}, listContextValue, compoundComponentContextValue), [listContextValue, compoundComponentContextValue]);
  let selectValue;
  if (props.multiple) {
...
var Select = React63.forwardRef(function Select2(props, forwardedRef) {
  ...
  return (0, import_jsx_runtime22.jsxs)(React63.Fragment, {
    children: [(0, import_jsx_runtime22.jsx)(Button3, _extends3({}, buttonProps, {
    ...
    })), buttonDefined && (0, import_jsx_runtime22.jsx)(Popup, _extends3({
      slots: {
        root: PopupComponent
      }
    }, popupProps, {
      children: (0, import_jsx_runtime22.jsx)(ListboxRoot, _extends3({}, listboxProps, {
        children: (0, import_jsx_runtime22.jsx)(SelectProvider, {
          value: contextValue,
          children
        })
      }))
    })), (0, import_jsx_runtime22.jsx)("input", _extends3({}, getHiddenInputProps(), {
      autoComplete
    }))]
  });
});
...
function useSlider(parameters) {
  ...
  const getRootProps = (externalProps = {}) => {
    ...
    const mergedEventHandlers = _extends3({}, externalHandlers, ownEventHandlers);
    return _extends3({}, externalProps, {
      ref: handleRef
    }, mergedEventHandlers);
  };
  ...
  const getThumbProps = (externalProps = {}) => {
    ...
    return _extends3({}, externalProps, externalHandlers, ownEventHandlers);
  };
  ...
  const getHiddenInputProps = (externalProps = {}) => {
    ...
    return _extends3({
      ...
      style: _extends3({}, visuallyHidden_default, {
...
var Slider = React65.forwardRef(function Slider2(props, forwardedRef) {
  ...
  const partialOwnerState = _extends3({}, props, {
    marks: marksProp,
    disabled,
    disableSwap,
    isRtl,
  ...
  const {
    ...
    trackLeap,
    getThumbStyle
  } = useSlider(_extends3({}, partialOwnerState, {
    rootRef: forwardedRef
  }));
  const ownerState = _extends3({}, partialOwnerState, {
  ...
  return (0, import_jsx_runtime23.jsxs)(Root, _extends3({}, rootProps, {
    children: [(0, import_jsx_runtime23.jsx)(Rail, _extends3({}, railProps)), (0, import_jsx_runtime23.jsx)(Track, _extends3({}, trackProps)), marks.filter((mark) => mark.value >= min3 && mark.value <= max3).map((mark, index2) => {
      ...
      return (0, import_jsx_runtime23.jsxs)(React65.Fragment, {
        children: [(0, import_jsx_runtime23.jsx)(Mark, _extends3({
          "data-index": index2
        ...
        })), mark.label != null ? (0, import_jsx_runtime23.jsx)(MarkLabel, _extends3({
          "aria-hidden": true,
          "data-index": index2
      ...
      return (0, import_jsx_runtime23.jsxs)(Thumb, _extends3({
        "data-index": index2
        ...
        style: _extends3({}, style4, getThumbStyle(index2), thumbProps.style, resolvedSlotProps == null ? void 0 : resolvedSlotProps.style),
        children: [(0, import_jsx_runtime23.jsx)(Input3, _extends3({
          "data-index": index2,
        ...
        }, inputProps)), ValueLabel ? (0, import_jsx_runtime23.jsx)(ValueLabel, _extends3({}, !isHostComponent(ValueLabel) && {
          valueLabelFormat,
          index: index2,
          disabled
        }, valueLabelProps, {
...
var Snackbar = React66.forwardRef(function Snackbar2(props, forwardedRef) {
  ...
  return (0, import_jsx_runtime24.jsx)(ClickAwayListener, _extends3({}, clickAwayListenerProps, {
    children: (0, import_jsx_runtime24.jsx)(Root, _extends3({}, rootProps, {
      children
    }))
  }));
});
...
function useSwitch(props) {
  ...
  const getInputProps = (otherProps = {}) => _extends3({
    checked: checkedProp,
    defaultChecked,
    disabled,
    readOnly,
...
var Switch = React68.forwardRef(function Switch2(props, forwardedRef) {
  ...
  return (0, import_jsx_runtime25.jsxs)(Root, _extends3({}, rootProps, {
    children: [(0, import_jsx_runtime25.jsx)(Track, _extends3({}, trackProps)), (0, import_jsx_runtime25.jsx)(Thumb, _extends3({}, thumbProps)), (0, import_jsx_runtime25.jsx)(Input3, _extends3({}, inputProps))]
  }));
});
...
var TablePaginationActions = React69.forwardRef(function TablePaginationActions2(props, forwardedRef) {
  ...
  return (0, import_jsx_runtime26.jsxs)(Root, _extends3({}, rootProps, {
    children: [showFirstButton && (0, import_jsx_runtime26.jsx)(FirstButton, _extends3({}, firstButtonProps, {
      children: direction === "rtl" ? (0, import_jsx_runtime26.jsx)(LastPageIcon, {}) : (0, import_jsx_runtime26.jsx)(FirstPageIcon, {})
    })), (0, import_jsx_runtime26.jsx)(BackButton, _extends3({}, backButtonProps, {
      children: direction === "rtl" ? (0, import_jsx_runtime26.jsx)(NextPageIcon, {}) : (0, import_jsx_runtime26.jsx)(BackPageIcon, {})
    })), (0, import_jsx_runtime26.jsx)(NextButton, _extends3({}, nextButtonProps, {
      children: direction === "rtl" ? (0, import_jsx_runtime26.jsx)(BackPageIcon, {}) : (0, import_jsx_runtime26.jsx)(NextPageIcon, {})
    })), showLastButton && (0, import_jsx_runtime26.jsx)(LastButton, _extends3({}, lastButtonProps, {
...
var TablePagination = React70.forwardRef(function TablePagination2(props, forwardedRef) {
  ...
  return (0, import_jsx_runtime27.jsx)(Root, _extends3({}, rootProps, {
    children: (0, import_jsx_runtime27.jsxs)(Toolbar, _extends3({}, toolbarProps, {
      children: [(0, import_jsx_runtime27.jsx)(Spacer, _extends3({}, spacerProps)), rowsPerPageOptions.length > 1 && (0, import_jsx_runtime27.jsx)(SelectLabel, _extends3({}, selectLabelProps, {
        children: labelRowsPerPage
      })), rowsPerPageOptions.length > 1 && (0, import_jsx_runtime27.jsx)(Select3, _extends3({}, selectProps, {
        children: rowsPerPageOptions.map((rowsPerPageOption) => (0, import_react2.createElement)(MenuItem4, _extends3({}, menuItemProps, {
          key: typeof rowsPerPageOption !== "number" && rowsPerPageOption.label ? rowsPerPageOption.label : rowsPerPageOption,
          value: typeof rowsPerPageOption !== "number" && rowsPerPageOption.value ? rowsPerPageOption.value : rowsPerPageOption
        }), typeof rowsPerPageOption !== "number" && rowsPerPageOption.label ? rowsPerPageOption.label : rowsPerPageOption))
      })), (0, import_jsx_runtime27.jsx)(DisplayedRows, _extends3({}, displayedRowsProps, {
      ...
      })), (0, import_jsx_runtime27.jsx)(Actions, _extends3({}, actionsProps))]
    }))
  }));
});
...
var Tabs = React74.forwardRef(function Tabs2(props, forwardedRef) {
  ...
  return (0, import_jsx_runtime29.jsx)(TabsRoot, _extends3({}, tabsRootProps, {
...
var TabPanel = React76.forwardRef(function TabPanel2(props, forwardedRef) {
  ...
  return (0, import_jsx_runtime30.jsx)(TabPanelRoot, _extends3({}, tabPanelRootProps, {
...
function useTabsList(parameters) {
  ...
  const getRootProps = (externalProps = {}) => {
    return _extends3({}, externalProps, getListboxRootProps(externalProps), {
      "aria-orientation": orientation === "vertical" ? "vertical" : void 0,
      role: "tablist"
    });
  };
  const contextValue = React77.useMemo(() => _extends3({}, compoundComponentContextValue, listContextValue), [compoundComponentContextValue, listContextValue]);
  return {
    contextValue,
    dispatch,
    getRootProps,
...
var TabsList = React79.forwardRef(function TabsList2(props, forwardedRef) {
  ...
  return (0, import_jsx_runtime32.jsx)(TabsListProvider, {
    value: contextValue,
    children: (0, import_jsx_runtime32.jsx)(TabsListRoot, _extends3({}, tabsListRootProps, {
      children
    }))
  });
});
...
function useTab(parameters) {
  ...
  const getRootProps = (externalProps = {}) => {
    ...
    return _extends3({}, externalProps, getCombinedRootProps(externalEventHandlers), {
      role: "tab",
...
var Tab = React81.forwardRef(function Tab2(props, forwardedRef) {
  ...
  return (0, import_jsx_runtime33.jsx)(TabRoot, _extends3({}, tabRootProps, {
    children
  }));
});
true ? Tab.propTypes = {
...
var TextareaAutosize = React82.forwardRef(function TextareaAutosize2(props, forwardedRef) {
  ...
  return (0, import_jsx_runtime34.jsxs)(React82.Fragment, {
    children: [(0, import_jsx_runtime34.jsx)("textarea", _extends3({
      value,
      onChange: handleChange,
      ref: handleRef,
      rows: minRows,
      ...
      ref: shadowRef,
      tabIndex: -1,
      style: _extends3({}, styles.shadow, style4, {
        paddingTop: 0,
        paddingBottom: 0
      })
    })]
...
function CssAnimation(props) {
  ...
  return (0, import_jsx_runtime35.jsx)("div", _extends3({
...
var CssTransition = React84.forwardRef(function CssTransition2(props, forwardedRef) {
  ...
  return (0, import_jsx_runtime36.jsx)("div", _extends3({
...
var useInsertionEffect2 = React86["useInsertionEffect"] ? React86["useInsertionEffect"] : false;
var useInsertionEffectAlwaysWithSyncFallback = useInsertionEffect2 || syncFallback;
var useInsertionEffectWithLayoutFallback = useInsertionEffect2 || React86.useLayoutEffect;

// node_modules/@emotion/react/dist/emotion-element-43c6fea0.browser.esm.js
var isBrowser2 = true;
var hasOwn = {}.hasOwnProperty;
var EmotionCacheContext = React87.createContext(
  ...
  withEmotionCache = function withEmotionCache3(func) {
    return function(props) {
      ...
      if (cache2 === null) {
        ...
        return React87.createElement(EmotionCacheContext.Provider, {
          value: cache2
        }, func(props, cache2));
      } else {
...
var ThemeContext = React87.createContext({});
if (true) {
...
var Global = withEmotionCache(function(props, cache2) {
  ...
  if (!isBrowser2) {
    ...
    return React88.createElement("style", (_ref = {}, _ref["data-emotion"] = cache2.key + "-global " + serializedNames, _ref.dangerouslySetInnerHTML = {
      __html: rules
...
function StyledEngineProvider(props) {
  ...
  return injectFirst && cache ? (0, import_jsx_runtime37.jsx)(CacheProvider, {
    value: cache,
    children
  }) : children;
}
...
function GlobalStyles(props) {
  ...
  return (0, import_jsx_runtime38.jsx)(Global, {
    styles: globalStyles
  });
}
...
function createBreakpoints(breakpoints) {
  const {
    ...
    unit = "px",
    step = 5
  } = breakpoints, other = _objectWithoutPropertiesLoose3(breakpoints, _excluded29);
...
function createTheme(options = {}, ...args) {
  const {
    ...
    spacing: spacingInput,
    shape: shapeInput = {}
  } = options, other = _objectWithoutPropertiesLoose3(options, _excluded30);
...
function createBox(options = {}) {
  ...
  const Box2 = React94.forwardRef(function Box3(inProps, ref) {
    ...
    const _extendSxProp = extendSxProp(inProps), {
      className,
      component = "div"
    } = _extendSxProp, other = _objectWithoutPropertiesLoose3(_extendSxProp, _excluded32);
    return (0, import_jsx_runtime40.jsx)(BoxRoot, _extends6({
      as: component,
      ref,
...
function processStyleArg(callableStyle, _ref) {
  let {
    ownerState
  } = _ref, props = _objectWithoutPropertiesLoose3(_ref, _excluded33);
  const resolvedStylesArg = typeof callableStyle === "function" ? callableStyle(_extends6({
    ownerState
  }, props)) : callableStyle;
  ...
  if (!!resolvedStylesArg && typeof resolvedStylesArg === "object" && Array.isArray(resolvedStylesArg.variants)) {
    const {
      variants = []
    } = resolvedStylesArg, otherStyles = _objectWithoutPropertiesLoose3(resolvedStylesArg, _excluded210);
    let result = otherStyles;
    variants.forEach((variant) => {
      let isMatch = true;
      if (typeof variant.props === "function") {
        isMatch = variant.props(_extends6({
          ownerState
        }, props, ownerState));
      } else {
      ...
      if (isMatch) {
        ...
        result.push(typeof variant.style === "function" ? variant.style(_extends6({
          ownerState
...
function createStyled3(input = {}) {
  ...
  return (tag, inputOptions = {}) => {
    ...
    } = inputOptions, options = _objectWithoutPropertiesLoose3(inputOptions, _excluded34);
    ...
    const transformStyleArg = (stylesArg) => {
      if (typeof stylesArg === "function" && stylesArg.__emotion_real !== stylesArg || isPlainObject(stylesArg)) {
        return (props) => processStyleArg(stylesArg, _extends6({}, props, {
          theme: resolveTheme({
            theme: props.theme,
            defaultTheme: defaultTheme5,
            themeId
    ...
    const muiStyledResolver = (styleArg, ...expressions) => {
      ...
      if (componentName && overridesResolver) {
        expressionsWithDefaultTheme.push((props) => {
          const theme = resolveTheme(_extends6({}, props, {
            defaultTheme: defaultTheme5,
            themeId
          }));
...
function RtlProvider(_ref) {
  let {
    value
  } = _ref, props = _objectWithoutPropertiesLoose3(_ref, _excluded35);
  return (0, import_jsx_runtime42.jsx)(RtlContext.Provider, _extends6({
    value: value ?? true
  }, props));
}
...
function useThemeScoping(themeId, upperTheme, localTheme, isPrivate = false) {
  return React100.useMemo(() => {
    ...
    if (typeof localTheme === "function") {
      ...
      const result = themeId ? _extends6({}, upperTheme, {
        [themeId]: mergedTheme
      }) : mergedTheme;
      if (isPrivate) {
        return () => result;
    ...
    return themeId ? _extends6({}, upperTheme, {
      [themeId]: localTheme
    }) : _extends6({}, upperTheme, localTheme);
...
function ThemeProvider3(props) {
  ...
  return (0, import_jsx_runtime43.jsx)(ThemeProvider_default, {
    ...
    children: (0, import_jsx_runtime43.jsx)(ThemeContext.Provider, {
      value: engineTheme,
      children: (0, import_jsx_runtime43.jsx)(RtlProvider_default, {
        value: rtlValue,
        children
      })
    })
...
true ? ThemeProvider3.propTypes = {
   ...
   * A theme object. You can provide a function to extend the outer theme.
   */
  theme: import_prop_types42.default.oneOfType([import_prop_types42.default.func, import_prop_types42.default.object]).isRequired,
  /**
   * The design system's unique id for getting the corresponded theme when there are multiple design systems.
   */
  themeId: import_prop_types42.default.string
} : void 0;
if (true) {
...
function useCurrentColorScheme(options) {
  ...
  const [state, setState] = React102.useState(() => {
  ...
  const setMode = React102.useCallback((mode) => {
  ...
  const setColorScheme = React102.useCallback((value) => {
    if (!value) {
      setState((currentState) => {
        try {
  ...
  const handleMediaQuery = React102.useCallback((event) => {
  ...
  const mediaListener = React102.useRef(handleMediaQuery);
...
var _excluded36 = ["colorSchemes", "components", "cssVarPrefix"];
...
function createCssVarsProvider(options) {
  ...
  const ColorSchemeContext = React103.createContext(void 0);
  if (true) {
    ColorSchemeContext.displayName = "ColorSchemeContext";
  }
  const useColorScheme = () => {
    const value = React103.useContext(ColorSchemeContext);
    if (!value) {
  ...
  function CssVarsProvider(props) {
    ...
    const hasMounted = React103.useRef(false);
    const upperTheme = useTheme4();
    const ctx = React103.useContext(ColorSchemeContext);
    ...
    const _ref = scopedTheme || themeProp, {
      ...
      components = {},
      cssVarPrefix
    } = _ref, restThemeProp = _objectWithoutPropertiesLoose3(_ref, _excluded36);
    ...
    const element = (0, import_jsx_runtime45.jsxs)(React103.Fragment, {
      children: [shouldGenerateStyleSheet && (0, import_jsx_runtime45.jsx)(React103.Fragment, {
        children: (((_b = theme.generateStyleSheets) == null ? void 0 : _b.call(theme)) || []).map((styles2, index2) => (0, import_jsx_runtime45.jsx)(GlobalStyles, {
          styles: styles2
        }, index2))
  ...
  true ? CssVarsProvider.propTypes = {
     ...
     */
    attribute: import_prop_types43.default.string,
    /**
     * The component tree.
     */
     ...
     */
    colorSchemeNode: import_prop_types43.default.any,
    /**
     * The CSS selector for attaching the generated custom properties
     */
    colorSchemeSelector: import_prop_types43.default.string,
    /**
     * localStorage key used to store `colorScheme`
     */
    colorSchemeStorageKey: import_prop_types43.default.string,
    /**
     * The initial color scheme used.
     */
    defaultColorScheme: import_prop_types43.default.oneOfType([import_prop_types43.default.string, import_prop_types43.default.object]),
    /**
     * The initial mode used.
     */
    defaultMode: import_prop_types43.default.string,
    /**
     * If `true`, the provider creates its own context and generate stylesheet as if it is a root `CssVarsProvider`.
     */
    disableNestedContext: import_prop_types43.default.bool,
    /**
     * If `true`, the style sheet won't be generated.
     *
     * This is useful for controlling nested CssVarsProvider behavior.
     */
    disableStyleSheetGeneration: import_prop_types43.default.bool,
    /**
     * Disable CSS transitions when switching between modes or color schemes.
     */
    disableTransitionOnChange: import_prop_types43.default.bool,
    /**
     * The document to attach the attribute to.
     */
    documentNode: import_prop_types43.default.any,
    /**
     * The key in the local storage used to store current color scheme.
     */
    modeStorageKey: import_prop_types43.default.string,
    /**
     * The window that attaches the 'storage' event listener.
     * @default window
     */
    storageWindow: import_prop_types43.default.any,
    /**
...
var _excluded37 = ["getSelector"];
var _excluded211 = ["colorSchemes", "components", "defaultColorScheme"];
function prepareCssVars(theme, _ref = {}) {
  let {
    getSelector
  } = _ref, parserConfig = _objectWithoutPropertiesLoose3(_ref, _excluded37);
  const {
    colorSchemes = {},
    defaultColorScheme = "light"
  } = theme, otherTheme = _objectWithoutPropertiesLoose3(theme, _excluded211);
  const {
    vars: rootVars,
    css: rootCss,
  ...
  } = colorSchemes, otherColorSchemes = _objectWithoutPropertiesLoose3(colorSchemes, [defaultColorScheme].map(toPropertyKey));
    ...
    function insertStyleSheet(selector, css2) {
      if (Object.keys(css2).length) {
        stylesheets.push(typeof selector === "string" ? {
          [selector]: _extends6({}, css2)
        } : selector);
      }
    }
    insertStyleSheet((getSelector == null ? void 0 : getSelector(void 0, _extends6({}, rootCss))) || ":root", rootCss);
    const {
      [colorScheme]: defaultSchemeVal
    } = colorSchemesMap, rest = _objectWithoutPropertiesLoose3(colorSchemesMap, [colorScheme].map(toPropertyKey));
    if (defaultSchemeVal) {
      const {
        css: css2
      } = defaultSchemeVal;
      insertStyleSheet((getSelector == null ? void 0 : getSelector(colorScheme, _extends6({}, css2))) || `[${theme.attribute || "data-color-scheme"}="${colorScheme}"]`, css2);
    }
    Object.entries(rest).forEach(([key, {
      css: css2
    }]) => {
      insertStyleSheet((getSelector == null ? void 0 : getSelector(key, _extends6({}, css2))) || `[${theme.attribute || "data-color-scheme"}="${key}"]`, css2);
    });
    return stylesheets;
  };
  return {
...
function createContainer(options = {}) {
  ...
  const Container2 = React104.forwardRef(function Container3(inProps, ref) {
    ...
    return (
      ...
      (0, import_jsx_runtime46.jsx)(ContainerRoot, _extends6({
        as: component,
        ownerState,
...
var generateGridStyles = ({
  ...
  }), (!ownerState.container || isNestedContainer(ownerState)) && _extends6({
...
function createGrid(options = {}) {
  ...
  const GridOverflowContext = React105.createContext(void 0);
  if (true) {
  ...
  const Grid2 = React105.forwardRef(function Grid3(inProps, ref) {
    const theme = useTheme_default();
    const themeProps = useThemeProps3(inProps);
    const props = extendSxProp(themeProps);
    const overflow2 = React105.useContext(GridOverflowContext);
    const {
      className,
      children,
    ...
    } = props, rest = _objectWithoutPropertiesLoose3(props, _excluded39);
    ...
    let result = (0, import_jsx_runtime47.jsx)(GridRoot, _extends6({
      ref,
      as: component,
      ownerState,
      className: clsx_default(classes.root, className)
      ...
      children: React105.Children.map(children, (child) => {
        if (React105.isValidElement(child) && isMuiElement(child, ["Grid"])) {
...
function createStack(options = {}) {
  ...
  const Stack2 = React106.forwardRef(function Grid2(inProps, ref) {
    const themeProps = useThemeProps3(inProps);
    const props = extendSxProp(themeProps);
    const {
      component = "div",
    ...
    return (0, import_jsx_runtime48.jsx)(StackRoot, _extends6({
      as: component,
      ownerState,
      ref,
      className: clsx_default(classes.root, className)
...
var _excluded42 = ["cssVarPrefix", "breakpoints", "spacing", "components", "variants", "shouldSkipGeneratingVar", "getSelector"];
...
function extendTheme(themeOptions) {
  ...
  const _ref = themeOptions || {}, {
    ...
    getSelector
  } = _ref, scalesInput = _objectWithoutPropertiesLoose(_ref, _excluded42);
  ...
  const getCssVarColor = (cssVar) => {
    ...
    return getCssVar(cssVar, (_a2 = defaultColors[color2]) == null ? void 0 : _a2[index2]);
  };
  ...
  const _ref2 = scalesInput ? deepmerge(defaultScales, scalesInput) : defaultScales, {
    colorSchemes
  } = _ref2, mergedScales = _objectWithoutPropertiesLoose(_ref2, _excluded213);
  let theme = _extends({
    colorSchemes,
    defaultColorScheme: "light"
  }, mergedScales, {
...
@mui/system/index.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-ZZ65KIF6.js.map
